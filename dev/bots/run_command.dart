...
final Directory rootDir = Directory(Platform.environment['PROJECT_ROOT']);

const List<String> dartModules = <String>['auth', 'movies', 'platform', 'root'];
const String flutterModule = 'mobile';
const List<String> allModules = <String>[...dartModules, flutterModule];
